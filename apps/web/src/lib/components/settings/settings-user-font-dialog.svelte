      ...
      <div class="border-b border-b-gray-200">
        <ul class="-mb-px flex items-center gap-4 text-sm font-medium">
          {#each tabs as tab (tab)}
            <li class="flex-1">
              <button
                class="relative flex items-center justify-center gap-2 rounded-lg px-3 py-2 transition-colors hover:bg-white hover:text-blue-700"
                class:bg-gray-900={currentTab === tab}
