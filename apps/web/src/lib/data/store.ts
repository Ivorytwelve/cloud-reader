...
/** Count short audiobook pauses (dictionary lookups, quick checks) as study time. */
export const audiobookCountShortPauses$ = writableBooleanLocalStorageSubject()(
  'audiobookCountShortPauses',
  false
);

/** Maximum paused duration, in seconds, that can be folded back into audiobook study time. */
export const audiobookShortPauseSeconds$ = writableNumberLocalStorageSubject()(
